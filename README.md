...
- Node.js
- A GitHub Personal Access Token (highly recommended to avoid API rate limits)
...
3. **Configuration:**
   ...
   PORT=3000
   ```
   *Note: Without a `GITHUB_TOKEN`, you will likely hit GitHub's API rate limit (60 requests/hour) very quickly. Authentication increases this to 5,000 requests/hour.*
